...
def load_images():
	...
	images['brandon_jaspers_highlighted'] = pyglet.resource.image('brandon_jaspers_highlighted.png')
	...
	rooms_highlighted = pyglet.resource.image('rooms_highlighted.png')
	images['rooms_highlighted'] = pyglet.image.ImageGrid(rooms_highlighted, 8, 8)
